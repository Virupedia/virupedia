...
include_once 'C://wamp64/www/test2/TravailProjet/newwork/Projetwebtest - Copy/Controller/CrudLivreur.php';
...
if (
    ...
    isset($_POST["nblivraison_Livreur"])
    ...
    )
 {
    if (
        ...
        !empty($_POST["nblivraison_Livreur"]) 
